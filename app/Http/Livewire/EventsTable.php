...
final class EventsTable extends PowerGridComponent
{
    ...
    *
    * @return  \Illuminate\Database\Eloquent\Builder<\App\Models\Event>|null
    */
    public function datasource(): ?Builder
    {
        return Event::query()
            ...
            ->where('locale', 'en')
            ->select('events.*', 'event_translations.title as title');
    }
    ...
    public function columns(): array
    {
        return [
            ...
            Column::add()
                ...
                ->field('title', 'event_translations.title')
                ->sortable()
                ->searchable()
                ->makeInputText(),
    ...
    */
    ...
    {
       try {
           $updated = Event::query()->findOrFail($data['id'])
                ->update([
