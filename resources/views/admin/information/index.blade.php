<x-admin.layouts.card>
    ...
    <x-slot name="cardHeader">
        <a href="{{ route('admin.information.create') }}" class="btn btn-secondary float-right"><i class="fas fa-plus"></i><span class="mx-2"> {{ __('admin.add') .' '. __('admin.information') }}</span></a>
    </x-slot>
